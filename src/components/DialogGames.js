            ...
            <DialogContent style={{margin: "0 auto", padding: "4rem"}} contentStyle={{width: "100%", maxWidth: "none"}}>
                <Grid container justify="center" spacing="40">
                    <Grid item lg={6} md={6} xs={12}>
                        ...
                        <p>City: {data.home_team.city}</p>
                        <p>Conference: {data.home_team.conference}</p>
                        <p>Division: {data.home_team.division}</p>
                    ...
                    <Grid item lg={6} md={6} xs={12}>
                        ...
                        <p>City: {data.visitor_team.city}</p>
                        <p>Conference: {data.visitor_team.conference}</p>
                        <p>Division: {data.visitor_team.division}</p>
                        <p>Visitor Team Score: {data.visitor_team_score}</p>
                    </Grid>
                </Grid>
